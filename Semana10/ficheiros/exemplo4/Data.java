...
public class Data {
    ...
    // -- metodos para escrita/leitura do ficheiro -----------------------------
    public void writeData(BufferedWriter out) throws IOException {
        out.write( toAnoMesDiaString() );
    }
    
    public static Data readData(BufferedReader in) throws IOException {        
        StringTokenizer s;
        
        s = new StringTokenizer ( in.readLine(), "\t/" );
        s.nextToken();
        
        int ano1 = Integer.parseInt( s.nextToken() );
        int mes1 = Integer.parseInt( s.nextToken() );
        int dia1 = Integer.parseInt( s.nextToken() );
        
        return new Data(ano1, mes1, dia1);
    }
