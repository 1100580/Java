 ...
 * @author i100642
 */
public class CanadaADCC implements InterfaceADCC {
    String status;
    Date data;
    private AutorizacaoDebitoCartaoCredito adcc;
    
    public CanadaADCC(String strNumCC, Date dataValidade, float fValorADCC){
