...
public class Empresa
{
    ...
    {
        ServicoAdicional sa = new ServicoAdicional("cadeira de criança",4, true);
        m_listCatalogoServicoAdicional.add(sa);

        sa = new ServicoAdicional("GPS",4, false);
        m_listCatalogoServicoAdicional.add(sa);

        sa = new ServicoAdicional("Seguro contra todos os riscos",4, false);
        m_listCatalogoServicoAdicional.add(sa);
    }
