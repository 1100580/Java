...
public class ArrasteImagemJLayeredPane2 extends JFrame {
    ...
    public ArrasteImagemJLayeredPane2(String titulo) {
        super(titulo);
    ...
    public static void main(String[] args) {
        ArrasteImagemJLayeredPane2 jan = new ArrasteImagemJLayeredPane2("Arraste de JLabel");
