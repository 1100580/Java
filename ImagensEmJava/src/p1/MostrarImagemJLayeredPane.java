...
public class MostrarImagemJLayeredPane extends JFrame {
    ...
    public MostrarImagemJLayeredPane(String titulo) {
        super(titulo);
    ...
    public static void main(String[] args) {
        MostrarImagemJLayeredPane jan = new MostrarImagemJLayeredPane("Mostrar Imagem");
